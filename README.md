...
Although designed for the Bangerz.tf communities' Engineer Fortress game mode, it includes enough configurability to be a good fit for any game mode.

None of this would be possible without Sourcemod and AlliedModders (https://github.com/alliedmodders/sourcemod).

Reverting upgrades was greatly facilitated by TF2Attributes (https://github.com/FlaminSarge/tf2attributes).

Finally a big thanks to Dynamilk of the Bangerz.tf community for his support and collaboration during development.
